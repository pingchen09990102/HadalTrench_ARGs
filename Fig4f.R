...
library(tidyr)
library(dplyr)
setwd("$HOME/HadalTrench_ARGs/Fig4f")
data <- read.delim("Fig4f.sourceData.txt", header = TRUE, sep = "\t")
data_long <- data %>%
...
ggsave("antibiotic_resistance_mechanisms.pdf", width = 8, height = 6, dpi = 300)
