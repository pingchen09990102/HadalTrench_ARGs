...
setwd("$HOME/HadalTrench_ARGs/Fig1e")
data<- read.table("Fig1e.sourceData.txt", sep="\t",  header=TRUE, stringsAsFactors=FALSE)
...
Radar
ggsave("Radar.pdf", plot = Radar, width = 10, height = 5)   
